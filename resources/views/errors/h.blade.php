    ...
    <div class="bg-white shadow-sm border-b">
        <div class="max-w-6xl mx-auto px-4 py-4">
            ...
            <div class="flex flex-wrap gap-2">
                <button onclick="showError('400')" class="px-3 py-1 bg-red-100 text-red-800 rounded-md text-sm hover:bg-red-200">400</button>
                <button onclick="showError('401')" class="px-3 py-1 bg-red-100 text-red-800 rounded-md text-sm hover:bg-red-200">401</button>
                <button onclick="showError('403')" class="px-3 py-1 bg-red-100 text-red-800 rounded-md text-sm hover:bg-red-200">403</button>
                <button onclick="showError('404')" class="px-3 py-1 bg-red-100 text-red-800 rounded-md text-sm hover:bg-red-200">404</button>
                <button onclick="showError('409')" class="px-3 py-1 bg-yellow-100 text-yellow-800 rounded-md text-sm hover:bg-yellow-200">409</button>
                <button onclick="showError('429')" class="px-3 py-1 bg-yellow-100 text-yellow-800 rounded-md text-sm hover:bg-yellow-200">429</button>
                <button onclick="showError('500')" class="px-3 py-1 bg-red-100 text-red-800 rounded-md text-sm hover:bg-red-200">500</button>
                <button onclick="showError('502')" class="px-3 py-1 bg-red-100 text-red-800 rounded-md text-sm hover:bg-red-200">502</button>
                <button onclick="showError('503')" class="px-3 py-1 bg-yellow-100 text-yellow-800 rounded-md text-sm hover:bg-yellow-200">503</button>
            </div>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center min-h-screen py-8">
        <div class="max-w-md w-full mx-4">
            ...
            <div id="error-502" class="error-page hidden">
                <div class="bg-white rounded-lg shadow-lg p-8 text-center">
                    ...
                    <p class="text-gray-600 mb-6">We're experiencing connectivity issues with our servers. This is typically a temporary problem.</p>

                    <div class="bg-red-50 rounded-lg p-4 mb-6">
                        <h3 class="text-sm font-medium text-red-900 mb-3">What's happening:</h3>
                        <div class="space-y-2 text-sm text-red-800">
                            <div class="flex items-center">
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="text-blue-800">Attempting to reconnect...</span>
                            </div>
                        </div>
                    </div>

                    <div class="bg-gray-50 rounded-lg p-4 mb-6">
                        <p class="text-sm text-gray-600">This page will automatically retry in <span id="retry-timer">30</span> seconds.</p>
                    </div>
                    ...
                    <div class="flex gap-3 justify-center">
                        ...
                        <button onclick="window.history.back()" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-lg hover:bg-gray-700 transition-colors">
                            <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                            </svg>
                            Go Back
        ...
        <div class="text-center py-8">
            <p class="text-sm text-gray-500">
                © <span id="current-year"></span> AFNON. All rights reserved.
            </p>
        </div>
    </div>
    ...
    <script>
        ...
        showError('404');
                    ...
                    <div class="flex gap-3 justify-center">
                        ...
                        <button onclick="window.location.reload()" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-lg hover:bg-gray-700 transition-colors">
                            <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path>
                            </svg>
                            Retry
