                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="loan_type" id="loan_type" required
                            class="mt-1 w-full px-3 py-2 border rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white">
                            <option value="co-funded" {{ old('loan_type', 'co-funded') == 'co-funded' ? 'selected' : '' }}>Co-funded (50% upfront)</option>
                            <option value="complete-loan" {{ old('loan_type') == 'complete-loan' ? 'selected' : '' }}>Complete Loan (commodity return)</option>
                        </select>
                    </div>
                    ...
                    <div>
                        <label for="insuranceRate"
                            ...
                            *</label>
                        <input type="number" id="insuranceRate" min="0" max="100" step="0.1" value="2"
                            name="insurance_rate" required
                            class="mt-1 w-full px-3 py-2 border rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white">
                    ...
                    <div id="reminder-days-wrapper">
                        ...
                        <input type="number" id="reminderDays" name="send_reminder_after_days" min="1"
                            value="{{ old('send_reminder_after_days') ?? '' }}" placeholder="e.g: 7"
                            class="mt-1 w-full px-3 py-2 border rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white">
