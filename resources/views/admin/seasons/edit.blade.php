                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="startDate" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Start
                            Date *</label>
                        <input type="date" id="startDate" name="start_date" value="{{ old('start_date', $season->start_date) }}" required
                            class="mt-1 w-full px-3 py-2 border rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white">
                    ...
                    <div>
                        <label for="endDate" class="block text-sm font-medium text-gray-700 dark:text-gray-300">End
                            Date *</label>
                        <input type="date" id="endDate" name="end_date" value="{{ old('end_date', $season->end_date) }}" required
                            class="mt-1 w-full px-3 py-2 border rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white">
                    ...
                    <div>
                        <label for="insuranceRate"
                            ...
                            *</label>
                        <input type="number" id="insuranceRate" min="0" max="100" step="0.1" value="{{ old('insurance_rate', $season->insurance_rate) }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="number" id="reminderDays" name="send_reminder_after_days" min="1"
                            value="{{ old('send_reminder_after_days', $season->send_reminder_after_days) }}" required placeholder="e.g: 3"
                            class="mt-1 w-full px-3 py-2 border rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white">
