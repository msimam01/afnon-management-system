...
@section('content')
    <div class="p-6">
        <div class="bg-white dark:bg-gray-800 shadow rounded-xl p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <form method="POST" action="{{ $season->status === 'open' ? route('admin.seasons.close', $season->uuid) : route('admin.seasons.reopen', $season->uuid) }}">
                    @csrf @method('PUT')
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700 text-gray-700 dark:text-gray-300">
                            @foreach ($commodities as $item)
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2 text-yellow-600">{{ $item->stock }}</td>
    ...
    <script>
        ...
        const allocatedData = @json($commodities->pluck('stock'));
