...
@section('content')
    ...
    <div class="">
        ...
        <!-- Applications Table and Bulk Approve Form -->
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
                ...
                <div class="p-6">
                    ...
                    <form method="GET" action="{{ route('admin.applications.index') }}" id="filterForm"
                        ...
                        <div>
                            ...
                            <select name="status" class="w-full px-3 py-2 rounded-md">
                        ...
                        <div>
                            ...
                            <select name="season" class="w-full px-3 py-2 rounded-md">
                                <option value="">All</option>
                                @foreach ($seasons as $season)
                                    <option value="{{ $season->name }}"
                                        {{ request('season') == $season->name ? 'selected' : '' }}>{{ $season->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            ...
                            <input type="text" name="search" value="{{ request('search') }}"
                                class="w-full pl-10 pr-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 smooth-transition" placeholder="Search farmer...">
                        </div>
                ...
                <div id="bulkRejectModal"
                    ...
                    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
                        <div class="mt-3">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Bulk Reject Applications
                            </h3>
                            <form id="bulkRejectForm" action="{{ route('admin.applications.bulk-reject') }}"
                                method="POST">
                                @csrf
                                <div id="bulkRejectIdsContainer"></div>
                                <div class="mb-4">
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Rejection
