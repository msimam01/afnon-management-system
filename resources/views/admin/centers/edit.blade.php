    ...
    <div class="max-w-5xl mx-auto py-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
            ...
            <div class="flex justify-between items-center px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Edit Center</h3>
            </div>

            <div class="p-6">


                <form action="{{ route('admin.centers.update', $center->uuid) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Center Name
                                *</label>
                            <input type="text" name="name" value="{{ $center->name }}" required placeholder="Center name"
                        ...
                        <div>
                            ...
                            <input type="text" name="lga" value="{{ $center->lga }}" required placeholder="lga"
                                class="w-full mt-1 px-3 py-2 border rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">address
                                *</label>
                            <input type="text" name="address" value="{{ $center->address }}" required placeholder="Location"
                                class="w-full mt-1 px-3 py-2 border rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white">
