...
@section('content')
    <div class="max-w-5xl mx-auto py-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
            ...
            <div class="p-6">
                @if (!$openSeason)
                    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 dark:bg-yellow-200 dark:text-yellow-900 px-4 py-3 rounded mb-4">
                        <strong>Heads up:</strong> No open season found. You cannot create new commodities until a season is opened.
                    </div>
                @else
                    <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-800 dark:bg-blue-900 dark:text-blue-300 px-4 py-3 rounded mb-6">
                        <strong>Note:</strong> Global commodities should be imported instead of created manually.
                    </div>
                    ...
                    <form action="{{ route('admin.commodities.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Commodity Name -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Commodity Name *</label>
                            ...
                            <!-- Price -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Price Per Unit (₦) *</label>
                            ...
                            <!-- Qty Per Hectare -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Qty Per Hectare *</label>
