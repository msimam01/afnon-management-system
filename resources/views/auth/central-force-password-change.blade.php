...
@section('content')
    <div class="min-h-screen flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="mt-8 space-y-6" action="{{ route('central.password.force.change.update') }}" method="POST" id="centralPasswordChangeForm">
                @csrf
                <div class="space-y-4">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const form = document.getElementById('centralPasswordChangeForm');
