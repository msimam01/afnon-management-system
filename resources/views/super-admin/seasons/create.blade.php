...
<div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
    ...
    <form method="POST" action="{{ route('superadmin.seasons.store') }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- Commodities -->
            <div>
                <label for="commodities" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Commodities *</label>
            ...
            <!-- Return Deadline -->
            <div>
                <label for="return_deadline" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Return Deadline *</label>
            ...
            <!-- Insurance Rate -->
            <div>
                <label for="insurance_rate" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Insurance Rate (%) *</label>
                <input type="number" name="insurance_rate" id="insurance_rate" min="0" max="100" step="0.1" value="2"
                    required class="mt-1 w-full px-3 py-2 border rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white">
            </div>

            <!-- Reminder Days -->
            <div>
                <label for="send_reminder_after_days" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Reminder Days After Deadline *</label>
            ...
            <!-- Budget -->
            <div>
                <label for="budget" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Total Budget (₦) *</label>
