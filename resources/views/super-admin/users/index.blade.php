                        ...
                        <tr class="px-6 py-4 text-gray-600 dark:text-gray-400">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form action="{{ route('superadmin.users.toggle-status', $item['uuid']) }}" method="POST" onsubmit="return confirm('Change user status?')">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    {{-- <form action="{{ route('superadmin.users.destroy', $item['uuid']) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
