...
@section('content')
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
        ...
        <div>
            <form action="{{ route('superadmin.commodities.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="commodityName" name="name" placeholder="e.g., Maize Seeds"
                    ...
                    <div>
                        ...
                        <select id="commodityCategory" name="category"
                            class="w-full mt-1 px-3 py-2 border rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white">
                    ...
                    <div>
                        <label for="unit" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Unit
                            *</label>
                        <input type="text" id="unit" name="unit" placeholder="e.g., bags, liters"
                            class="w-full mt-1 px-3 py-2 border rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white">
                    ...
                    <div>
                        <label for="qtyPerHectare"
                            ...
                            *</label>
                        <input type="number" id="qtyPerHectare" name="qtyPerHectare" step="0.1"
                            min="0"
                            class="w-full mt-1 px-3 py-2 border rounded-md bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white"
