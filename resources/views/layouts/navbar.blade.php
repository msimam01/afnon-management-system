            ...
            <div class="flex items-center">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="hidden sm:block">
                        <h1 class="text-xl lg:text-2xl font-bold text-emerald-800">{{ $isCentral ? $setting->name ?? 'AFNEN' : ($tenant->short_name ?? strtoupper($tenant->id)) . ' STATE CHAPTER' }}</h1>
                        <p class="text-xs text-emerald-600 font-medium hidden md:block">Association Of Farmers In The Northeast Of Nigeria</p>
                    </div>
                    <!-- Mobile title -->
                    <div class="sm:hidden">
                        <h1 class="text-lg font-bold text-emerald-800">{{ $isCentral ? 'AFNEN' : ($tenant->short_name ?? strtoupper($tenant->id)) }}</h1>
                    </div>
                </div>
            </div>
